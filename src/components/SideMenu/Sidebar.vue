  ...
  >
    ...
    <div class="h-full flex flex-col relative overflow-hidden">
      <header class="px-6 pt-8 pb-6 flex items-center">
        <div class="w-12 h-12 rounded-[14px] bg-white flex items-center justify-center shadow-md mx-auto transition-all duration-300" :class="isCollapsed ? 'scale-90' : 'ml-0'">
          ...
          <li v-for="option in menuOptions" :key="option.name" class="flex flex-col">
            ...
            >
              <div class="flex items-center gap-4">
                ...
                <span 
                  v-if="!isCollapsed" 
                  class="text-[15px] font-medium tracking-wide whitespace-nowrap"
                >
                  {{ option.name }}
                </span>
              </div>
              ...
              <div v-if="!isCollapsed" class="flex items-center gap-2">
                <template v-if="option.badges">
                  <span 
                    v-for="(badge, idx) in option.badges" 
                    :key="idx"
            ...
            <div 
              v-show="!isCollapsed && option.children && expandedMenus[option.value]" 
                ...
                <li v-for="child in option.children" :key="child.name">
                  ...
                  >
                    ...
                    <span 
                      ...
                      class="material-symbols-outlined text-[18px] text-gray-300"
                    >
                      chevron_right
                    </span>
                  </button>
