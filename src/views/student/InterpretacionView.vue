...
import {useInterpretacionesStore} from "@/stores/student/Interpretaciones.js";
import {storeToRefs} from "pinia";

const route = useRoute();
const interpretation = useInterpretacionesStore();

const {interpretaciones} = storeToRefs(interpretation);

const fetchInterpretacion = async () => {
  const formId = route.params.formId;
  const attemptId = route.params.attemptId;

  await interpretation.fetchFormWithAnswers(formId, attemptId);
}
